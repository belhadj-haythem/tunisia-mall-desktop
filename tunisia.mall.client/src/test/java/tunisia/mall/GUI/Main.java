...
class MediaControl extends BorderPane {
  ...
  public MediaControl(final MediaPlayer mp) {
    ...
    mediaBar.setPrefSize(50, 60);
    // mediaBar.setTranslateX(value);
    BorderPane.setAlignment(mediaBar, Pos.TOP_RIGHT);
    ...
    mp.setCycleCount(repeat ? MediaPlayer.INDEFINITE : 3);
    ...
    BackgroundSize bgS = new BackgroundSize(568, 58, false, false, false, false);
    Background bg = new Background(new BackgroundImage(new Image("file:///C:/workspace/tunisia.mall.client/Images/sound.jpg"), NO_REPEAT, NO_REPEAT, null, bgS));
    mediaBar.setBackground(bg);
    ...
    playTime.setStyle("-fx-text-fill: #FFFFFF;");
...
public class Main {
  ...
  private static final String MEDIA_URL = "file:///C:/workspace/tunisia.mall.client/Images/demo.flv";
  ...
  public Pane start() {
    ...
    Scene scene = new Scene(root, 464, 53);
    ...
    mediaControl.setMaxWidth(mediaControl.getWidth()-10);
    return mediaControl;
